...
<body
    style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
     background: linear-gradient(135deg, #db165b, #673187, #f7b63e); height: 100%; margin: 0; padding: 0; width: 100%">
    <center>
 ...
 100%;     background: linear-gradient(135deg, #db165b, #673187, #f7b63e); height: 100%; margin: 0; padding: 0; width:
 100%"
            width="100%">
            <tr>
 ...
 border-top: 0; border-bottom: 0; padding-top: 16px; padding-bottom: 0"
                                valign="top">
 ...
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;"
                                                                valign="top">
                                                                <a class="" href="javascript:void(0);"
                                                                    style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none"
                                                                    target="_blank" title="">
                                                                    <a class="" href="javascript:void(0);"
                                                                        style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color:
 #f57153; font-weight: normal; text-decoration: none"
                                                                        ...
                                                                        <img align="center" alt="Forgot your password?"
                                                                            class="mcnImage"
                                                                            src="https://www.agilecrm.com/img/helpdesk/call-scripts1.png"
 ...
 0; display: inline !important; vertical-align: bottom;"
                        ...
                        <tr>
                            <td id="templateBody"
                                style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f7f7ff;
 border-top: 0; border-bottom: 0; padding-top: 0; padding-bottom: 0"
                                valign="top">
 ...
 padding-bottom: 9px; padding-left: 18px;'
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="mcnTextBlock"
                                    style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace:
 ...
 100%; min-width:100%;"
           ...
           padding-left: 18px;'
                                                                ...
                                                                Hello
                                                                <strong>{{ $lead->name ?? 'Valued Customer' }}</strong>,<br><br>

                                                                We noticed you reached out to us recently but haven’t
                                                                received a response yet.
                                                                Our sales team wanted to make sure your request didn’t
                                                                go unanswered. 😊 <br><br>

                                                                If you still need assistance, simply reply to this email
                                                                —
                                                                we’ll get back to you as soon as possible.
                                                                If your issue has already been resolved, please
                                                                disregard this message.<br><br>

                                                                <strong>Lead Reference Service:</strong>
                                                                {{ data_get($lead->meta, 'service', 'N/A') }}<br><br>

                                                                <em>Thank you for your patience and interest. We look
                                                                    forward to connecting with you soon!</em><br><br>

                                                                <h5 style="margin-top: 10px; color: #007bff;">– The DPM
                                                                    Team</h5>
                                                    ...
                                                    <tbody class="mcnButtonBlockOuter">
                                                        <tr>
                                                            <td align="center" class="mcnButtonBlockInner"
                                                                style="mso-line-height-rule:
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;"
                                                                valign="top">
                                                                <table border="0" cellpadding="0" cellspacing="0"
