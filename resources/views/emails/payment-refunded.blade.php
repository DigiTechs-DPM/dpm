                    ...
                    <table class="templateContainer" width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="padding: 25px 20px; text-align:center; font-family:'Asap', sans-serif;">
                                ...
                                <h3 style="color:#c443e4; margin-bottom:10px;">Refund Details</h3>
                                ...
                                <p style="text-align:left; font-size:16px; line-height:1.6; color:#2a2a2a;">
                                    ...
                                    <strong>Refunded Amount:</strong> {{ $refundedAmount }}<br>

                                    @if ($refundType === 'partial' && $remainingAmount)
                                        <strong>Remaining Applied Amount:</strong> {{ $remainingAmount }}<br>
                                    @endif

                                    @if ($reason)
                                        <strong>Note:</strong> {{ $reason }}<br>
                                    @endif
                                </p>

                                <p style="margin-top:15px; font-size:14px; color:#2a2a2a;">
                                ...
                                <em style="font-size:15px; color:#444;">
                                    If you have any questions about this refund,<br>
