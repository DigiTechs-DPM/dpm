...
@section('title', 'Seller | Payment Link')
...
@section('sellers-content')
        ...
        <form method="POST"
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="hidden" class="form-control" name="order_type" value="{{ $orderType }}">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" name="total_amount" step="0.01"
                        placeholder="e.g., 4000.00" value="{{ $totalDefault }}" {{ $isOrder ? 'readonly' : 'required' }}>
                    @if ($isOrder)
    ...
    {{-- optional: front-end guard to prevent typing over the due --}}
    @if ($isOrder)
        <script>
