                ...
                <div class="heading d-flex justify-content-between">
                    <div>
                        ...
                        @php
                            ...
                            $isAdmin = $user !== null;
                            // check role inside meta
                            $isSuperAdmin =
                                $isAdmin && is_array($meta) && isset($meta['role']) && $meta['role'] === 'white_wolf';
                        @endphp
                        @if ($orders->count() >= 300)
                            @if ($isAdmin || $isSuperAdmin)
                                <button class="btn btn-success btn-sm" type="button" id="download-csv">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="invoiceTable">
                        ...
                        <tbody class="border">
                            ...
                            @empty
                                <tr>
                                    <td colspan="{{ $isAdmin ? 9 : 8 }}" class="text-center text-muted">No orders found.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
